...
@register_model
def leit_inter_tiny_patch16_224(pretrained=False, **kwargs):
...
@register_model
def leit_inter_small_patch16_224(pretrained=False, **kwargs):
    model = VisionTransformer(
...
@register_model
def leit_inter_base_patch16_224(pretrained=False, **kwargs):
    model = VisionTransformer(
